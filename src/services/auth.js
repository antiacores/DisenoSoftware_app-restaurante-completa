...
const registerUser = async (email, password, name) => {
    try {
        ...
        await setDoc(userDocRef, {
            correo: email,
            created: new Date().toISOString(), // Convierte a string para mejor compatibilidad
            nombre: name,
            role: "cliente" //cualquier registro nuevo será cliente pq solo hay un admin y se estableció en firebase
        });
        
        console.log("Registro de usuario con exito:", userCredential.user.uid);
